...
namespace WP_Groove\Skeleton_Theme_Pro\Tests\WP_Docker;
 ...
 *
 * @since 2021-12-15
 * @coversDefaultClass \WP_Groove\Skeleton_Theme_Pro\Theme
 */
final class Theme_Tests extends WPG_Pro_Tests\A6t\Base {
	/**
	 * @covers ::load()
	 * @covers ::instance()
	 */
	public function test_plugin() : void {
		$theme = WP\Theme::instance();
		$this->assertSame( 'w6e', $theme->brand->n7m, $this->message() );
	}
}
